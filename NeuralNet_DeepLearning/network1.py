...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 28 00:05:12 2020
...
class Network(object):
    def __init__(self, sizes):
        ...
        any biases for those neurons, since biases are only ever used in computing the outputs from 
        later layers."""
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data = None):
        ...
        the desired outputs. The other non-optional parameters are elf-explanatory.  If `test_data` 
        is provided then the network will be evaluated against the test data after each epoch, 
        and partial progress printed out. This is useful for tracking progress, but slows things 
        down substantially."""
    ...
    def backprop(self, x, y):
        ...
        #backward pass
        delta = self.cost_dericative(activations[-1], y) * self.sigmoid_prime(zs[-1])
        nabla_b[-1] = delta
        ...
        neurons, l = 2 is the second-last layer, and so on.  It's a renumbering of the
        scheme in the book, used here to take advantage of the fact that Python can use 
    ...
    def cost_dericative(self, output_activations, y):
        """Return the vector of partial derivatives `partial a for the output activations."""
